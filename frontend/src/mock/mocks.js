// 嵌入演示 mock 数据（从真实后端响应 / init.sql 结构整理；仅 VUE_APP_EMBEDDED_DEMO 构建使用）
const books = [
...
export default {
  ...
  '/sys/user/selectByAccount': () => ok({ account: '2020001', certId: '2020001', head: null, password: '123456', status: 0, time: '2026-8-9', username: '演示用户' }),
  ...
  '/library/book/selectByCallNo': () => ok(bookDetail),
  '/library/book/selectBookExtendByCallNo': () => ok(bookDetail),
